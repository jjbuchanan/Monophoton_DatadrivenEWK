              ...
              if(elelist.size() == 1 && looseEles.size() == 1 && looseMus.size() == 0)
              {
                ...
                if(leptoMET > 170)
                {
                  if(DeltaPhi(phoPhi->at(phoCand1[0]),leptoMET_phi) > 2.0)
                  {
                    ...
                    fillHistos(110,event_weight,phoCand1[0],jetveto,elelist,leptoMET,leptoMET_phi);
                    //PDF
                    ...
                    for(unsigned int i = 0; i < nMCreplicas; i++)
                    {
                      ...
                      fillHistos(i,event_weight*lheNormalizedWeights->at(vecIndices[i]),phoCand1[0],jetveto,elelist,leptoMET,leptoMET_phi);
                    }
                    //Scale
                    ...
                    fillHistos(nMCreplicas,event_weight*genWeight_QCDscale_muR1_muF1,phoCand1[0],jetveto,elelist,leptoMET,leptoMET_phi);
                    fillHistos(nMCreplicas+1,event_weight*genWeight_QCDscale_muR1_muF2,phoCand1[0],jetveto,elelist,leptoMET,leptoMET_phi);
                    fillHistos(nMCreplicas+2,event_weight*genWeight_QCDscale_muR1_muF0p5,phoCand1[0],jetveto,elelist,leptoMET,leptoMET_phi);
                    fillHistos(nMCreplicas+3,event_weight*genWeight_QCDscale_muR2_muF1,phoCand1[0],jetveto,elelist,leptoMET,leptoMET_phi);
                    fillHistos(nMCreplicas+4,event_weight*genWeight_QCDscale_muR2_muF2,phoCand1[0],jetveto,elelist,leptoMET,leptoMET_phi);
                    fillHistos(nMCreplicas+5,event_weight*genWeight_QCDscale_muR2_muF0p5,phoCand1[0],jetveto,elelist,leptoMET,leptoMET_phi);
                    fillHistos(nMCreplicas+6,event_weight*genWeight_QCDscale_muR0p5_muF1,phoCand1[0],jetveto,elelist,leptoMET,leptoMET_phi);
                    fillHistos(nMCreplicas+7,event_weight*genWeight_QCDscale_muR0p5_muF2,phoCand1[0],jetveto,elelist,leptoMET,leptoMET_phi);
                    fillHistos(nMCreplicas+8,event_weight*genWeight_QCDscale_muR0p5_muF0p5,phoCand1[0],jetveto,elelist,leptoMET,leptoMET_phi);
                  }
                }
              }
            }
