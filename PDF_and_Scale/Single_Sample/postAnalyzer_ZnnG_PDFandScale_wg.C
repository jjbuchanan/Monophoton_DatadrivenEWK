                ...
                if(DeltaPhi(phoPhi->at(phoCand1[0]),pfMETPhi)>2.0)
                {
                  if(electron_veto_looseID(phoCand1[0],10).size() == 0 &&  muon_veto_looseID(phoCand1[0],10).size() == 0)
                  {
                    if(dPhiJetMET_veto(jetveto))
                    {
                      ...
                      fillHistos(110,NNLO_weight,phoCand1[0],jetveto);
                      //PDF
                      ...
                      for(unsigned int i = 0; i < nMCreplicas; i++)
                      {
                        ...
                        fillHistos(i,NNLO_weight*lheNormalizedWeights->at(vecIndices[i]),phoCand1[0],jetveto);
                      }
                      //Scale
                      ...
                      fillHistos(nMCreplicas,NNLO_weight*genWeight_QCDscale_muR1_muF1,phoCand1[0],jetveto);
                      fillHistos(nMCreplicas+1,NNLO_weight*genWeight_QCDscale_muR1_muF2,phoCand1[0],jetveto);
                      fillHistos(nMCreplicas+2,NNLO_weight*genWeight_QCDscale_muR1_muF0p5,phoCand1[0],jetveto);
                      fillHistos(nMCreplicas+3,NNLO_weight*genWeight_QCDscale_muR2_muF1,phoCand1[0],jetveto);
                      fillHistos(nMCreplicas+4,NNLO_weight*genWeight_QCDscale_muR2_muF2,phoCand1[0],jetveto);
                      fillHistos(nMCreplicas+5,NNLO_weight*genWeight_QCDscale_muR2_muF0p5,phoCand1[0],jetveto);
                      fillHistos(nMCreplicas+6,NNLO_weight*genWeight_QCDscale_muR0p5_muF1,phoCand1[0],jetveto);
                      fillHistos(nMCreplicas+7,NNLO_weight*genWeight_QCDscale_muR0p5_muF2,phoCand1[0],jetveto);
                      fillHistos(nMCreplicas+8,NNLO_weight*genWeight_QCDscale_muR0p5_muF0p5,phoCand1[0],jetveto);
                    }
                  }
                }
              }
