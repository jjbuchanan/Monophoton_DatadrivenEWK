...
void postAnalyzer::Loop(Long64_t maxEvents, int reportEvery)
{
  ...
  for(int i = 1; i <= ewkCorrection->GetXaxis()->GetNbins(); i++)
   {
     cout<<"Contents of ewkCorrection bin "<<i<<": "<<ewkCorrection->GetBinContent(i)<<endl;
   }
  cout<<endl;
              ...
              if(mulist.size() == 1 && looseMus.size() == 1 && looseEles.size() == 0)
              {
                ...
                if(leptoMET > 170)
                {
                  if(DeltaPhi(phoPhi->at(phoCand1[0]),leptoMET_phi) > 2.0)
                  {
                    ...
                    fillHistos(110,NNLO_weight,phoCand1[0],jetveto,mulist,leptoMET,leptoMET_phi);
                    //PDF
                    ...
                    for(unsigned int i = 0; i < nMCreplicas; i++)
                    {
                      ...
                      fillHistos(i,NNLO_weight*lheNormalizedWeights->at(vecIndices[i]),phoCand1[0],jetveto,mulist,leptoMET,leptoMET_phi);
                    }
                    //Scale
                    ...
                    fillHistos(nMCreplicas,NNLO_weight*genWeight_QCDscale_muR1_muF1,phoCand1[0],jetveto,mulist,leptoMET,leptoMET_phi);
                    fillHistos(nMCreplicas+1,NNLO_weight*genWeight_QCDscale_muR1_muF2,phoCand1[0],jetveto,mulist,leptoMET,leptoMET_phi);
                    fillHistos(nMCreplicas+2,NNLO_weight*genWeight_QCDscale_muR1_muF0p5,phoCand1[0],jetveto,mulist,leptoMET,leptoMET_phi);
                    fillHistos(nMCreplicas+3,NNLO_weight*genWeight_QCDscale_muR2_muF1,phoCand1[0],jetveto,mulist,leptoMET,leptoMET_phi);
                    fillHistos(nMCreplicas+4,NNLO_weight*genWeight_QCDscale_muR2_muF2,phoCand1[0],jetveto,mulist,leptoMET,leptoMET_phi);
                    fillHistos(nMCreplicas+5,NNLO_weight*genWeight_QCDscale_muR2_muF0p5,phoCand1[0],jetveto,mulist,leptoMET,leptoMET_phi);
                    fillHistos(nMCreplicas+6,NNLO_weight*genWeight_QCDscale_muR0p5_muF1,phoCand1[0],jetveto,mulist,leptoMET,leptoMET_phi);
                    fillHistos(nMCreplicas+7,NNLO_weight*genWeight_QCDscale_muR0p5_muF2,phoCand1[0],jetveto,mulist,leptoMET,leptoMET_phi);
                    fillHistos(nMCreplicas+8,NNLO_weight*genWeight_QCDscale_muR0p5_muF0p5,phoCand1[0],jetveto,mulist,leptoMET,leptoMET_phi);
                  }
                }
              }
            }
