...
void postAnalyzer::Loop(Long64_t maxEvents, int reportEvery)
{
  ...
  double nObs_lepton_MET_unweighted;
  nObs_lepton_MET_unweighted = 0.0;
  double nObs_bin1_unweighted, nObs_bin2_unweighted, nObs_bin3_unweighted, nObs_bin4_unweighted, nObs_bin5_unweighted;
  nObs_bin1_unweighted = nObs_bin2_unweighted = nObs_bin3_unweighted = nObs_bin4_unweighted = nObs_bin5_unweighted = 0.0;
  ...
  std::cout<<std::endl;
  cout<<"nObs_lepton_MET_unweighted: "<<nObs_lepton_MET_unweighted<<endl;
  cout<<"nObs_bin1_unweighted: "<<nObs_bin1_unweighted<<endl;
  cout<<"nObs_bin2_unweighted: "<<nObs_bin2_unweighted<<endl;
  cout<<"nObs_bin3_unweighted: "<<nObs_bin3_unweighted<<endl;
  cout<<"nObs_bin4_unweighted: "<<nObs_bin4_unweighted<<endl;
  cout<<"nObs_bin5_unweighted: "<<nObs_bin5_unweighted<<endl;
