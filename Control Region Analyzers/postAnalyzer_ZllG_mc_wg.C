...
void postAnalyzer::Loop(Long64_t maxEvents, int reportEvery)
{
  ...
  double nRecoFound_unweighted, nObs_dilepton_z_window_unweighted;
  nRecoFound_unweighted = nObs_dilepton_z_window_unweighted = 0.0;
  ...
  std::cout<<std::endl;
  cout<<"nObs_dilepton_z_window_unweighted: "<<nObs_dilepton_z_window_unweighted<<endl;
