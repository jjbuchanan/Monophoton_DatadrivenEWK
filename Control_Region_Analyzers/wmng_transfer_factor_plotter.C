...
void plot(TString histname, Double_t yaxis_compress, Double_t leg_xoffset, Double_t leg_yoffset, TString xaxis_title, TString plotname)
{
  ...
  TFile* f_WmnG_WGJets = new TFile("WenG_WGJets.root");
  TH1F* histo_WmnG_WGJets = (TH1F*)f_WmnG_WGJets->Get(histname);
  histo_WmnG_WGJets->SetStats(0);
  // histo_WmnG_WGJets->Scale(1.0/483496.0);
  // histo_WmnG_WGJets->Scale(0.6637);
  histo_WmnG_WGJets->SetTitle("");
  histo_WmnG_WGJets->GetXaxis()->SetTitle("");
  histo_WmnG_WGJets->GetXaxis()->SetTickLength(0);
  histo_WmnG_WGJets->GetXaxis()->SetLabelOffset(999);
  histo_WmnG_WGJets->GetYaxis()->SetTitle("");
  histo_WmnG_WGJets->GetYaxis()->SetTickLength(0);
  histo_WmnG_WGJets->GetYaxis()->SetLabelOffset(999);
  ...
  {
    Double_t x_value = histo_ZnnG_WGJets->GetBinCenter(i);
    ...
    if(histo_ZnnG_WGJets->GetBinContent(i) > 0.0){
      Double_t N_bin_WGinWmnG = histo_WmnG_WGJets->GetBinContent(i);
      Double_t N_bin_WGinZnnG = histo_ZnnG_WGJets->GetBinContent(i);
      y_value = N_bin_WGinWmnG / N_bin_WGinZnnG;
      y_error_up = y_value*sqrt((N_bin_WGinWmnG*(1.0-N_bin_WGinWmnG/483496.0))/(N_bin_WGinWmnG*N_bin_WGinWmnG) + (N_bin_WGinZnnG*(1.0-N_bin_WGinZnnG/483496.0))/(N_bin_WGinZnnG*N_bin_WGinZnnG));
  ...
  transfer_factor->GetYaxis()->SetRangeUser(0.0,5.0);
...
//   leg->Draw();
  ...
  c->SaveAs(TString("transfer_znngWGJets_to_wengWGJets_"+plotname+".png"));
  c->SaveAs(TString("transfer_znngWGJets_to_wengWGJets_"+plotname+".pdf"));
  delete(c);
}

void wmng_transfer_factor_plotter()
{
