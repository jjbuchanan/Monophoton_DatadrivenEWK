...
void plot(TString histname, Double_t yaxis_compression, Double_t leg_xoffset, Double_t leg_yoffset, TString xaxis_title, TString plotname)
{
  ...
  TFile* f_WG = new TFile("WenG_WGJets.root");
...
//  }
  ...
  TFile *f_GJets_40to100 = new TFile("WenG_GJets_HT-40to100.root");
  TFile *f_GJets_100to200 = new TFile("WenG_GJets_HT-100to200.root");
  TFile *f_GJets_200to400 = new TFile("WenG_GJets_HT-200to400.root");
  TFile *f_GJets_400to600 = new TFile("WenG_GJets_HT-400to600.root");
  TFile *f_GJets_600toInf = new TFile("WenG_GJets_HT-600toInf.root");
  ...
  TFile *f_ZllG = new TFile("WenG_ZLLGJets.root");
  ...
  TFile *f_TTG = new TFile("WenG_TTGJets.root");
  ...
  TFile *f_TG = new TFile("WenG_TGJets.root");
  ...
  TFile* f_WWG = new TFile("WenG_WWG.root");
...
//  TFile* f_Diphoton = new TFile("WenG_DiPhotonJets.root");
