...
void plot(TString histname, Double_t yaxis_compress, Double_t leg_xoffset, Double_t leg_yoffset, TString xaxis_title, TString plotname)
{
  ...
  TFile *f_elefake = new TFile("WmnG_wenu_all.root");
  ...
  TFile* f_WG = new TFile("WmnG_WGJets.root");
...
//  }
  ...
  TFile *f_GJets_40to100 = new TFile("WmnG_GJets_HT-40to100.root");
  TFile *f_GJets_100to200 = new TFile("WmnG_GJets_HT-100to200.root");
  TFile *f_GJets_200to400 = new TFile("WmnG_GJets_HT-200to400.root");
  TFile *f_GJets_400to600 = new TFile("WmnG_GJets_HT-400to600.root");
  TFile *f_GJets_600toInf = new TFile("WmnG_GJets_HT-600toInf.root");
  ...
  TFile *f_ZllG = new TFile("WmnG_ZLLGJets.root");
  ...
  TFile *f_TTG = new TFile("WmnG_TTGJets.root");
  ...
  TFile *f_TG = new TFile("WmnG_TGJets.root");
  ...
  TFile* f_WWG = new TFile("WmnG_WWG.root");
...
//  TFile* f_Diphoton = new TFile("WmnG_DiPhotonJets.root");
